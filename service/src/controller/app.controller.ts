...
export class AppController {
  ...
  async chatfile(@Body() body: any) {
    console.log("api调用: chat - Glm文档问答");
    let knowledgeBase = body.knowledgeBase || "英语";
    return await this.appService.chatfile(
      body,
      this.mapKnowledgeBase(knowledgeBase),
    );
  }
  ...
  async chatfileContent(@Body() body: any) {
    console.log("api调用: chat - Glm文档问答--只获取文档内容");
    let knowledgeBase = body.knowledgeBase || "英语";
    return await this.appService.chatfileContent(
      body,
      this.mapKnowledgeBase(knowledgeBase),
    );
  }
